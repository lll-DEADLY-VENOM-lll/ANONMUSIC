...
YTPROXY_URL = getenv("YTPROXY_URL", "https://xyz.spotifytech.shop")
YT_API_KEY = getenv("YT_API_KEY", "SANATANI_TECH")
WEBSITE = getenv("WEBSITE", "https://xyz.spotifytech.shop")
COOKIES_URL = getenv("COOKIES_URL", "https://batbin.me/raw/manor")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Vibe-Bots/SanataniTechApi")
...
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/9y7iem.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/evfl03.jpg")
